  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-elevated hover:-translate-y-0.5 hover:shadow-glow",
        glass: "border border-border/60 bg-card/75 text-foreground shadow-soft backdrop-blur-xl hover:-translate-y-0.5 hover:bg-card",
        soft: "bg-secondary text-foreground shadow-soft hover:-translate-y-0.5 hover:bg-secondary/80",
        ghostGlow: "text-foreground hover:bg-secondary hover:text-foreground",
      },
      size: {
